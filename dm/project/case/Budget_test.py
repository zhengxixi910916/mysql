...
class Budget(unittest.TestCase):
    ...
    def tearDownClass(cls):
        ...
        if Budget.budget_template_id != "":
            DB.instance().clear(section="project", table="ERDCLOUD_PROJECT_TEST.budget_elbudget_template", eid=Budget.budget_template_id)
        if Budget.budget_category_id != "":
            DB.instance().clear(section="project", table="ERDCLOUD_PROJECT_TEST.budget_elbudget_category", eid=Budget.budget_template_id)
        if Budget.parts_id != "":
            DB.instance().clear(section="project", table="ERDCLOUD_PROJECT_TEST.budget_elbudget_category", eid=Budget.parts_id)
        if Budget.stage_id != "":
            DB.instance().clear(section="project", table="ERDCLOUD_PROJECT_TEST.budget_elbudget_project_entry", eid=Budget.stage_id)
        if Budget.cost_id != "":
            DB.instance().clear(section="project", table="ERDCLOUD_PROJECT_TEST.budget_elbudget_project_cost", eid=Budget.cost_id)
